...
You would clone this repo as a starting point after you install [ALLEGRO](https://github.com/ucrbioinfo/ALLEGRO) via `pip install allegro-bio`. Then, cd into this repo folder, and run `allegro` to use the default configurations.
